...
namespace TmLox.Interpreter.Tests
{
    public class VariableModificationTests
    {
        ...
        [Test]
        public void Test_Variable_Addition_Modification_With_First_Argument_As_Integer_And_Second_Argument_As_Float_Should_Produce_Valid_Float()
        {
            var code = @"
                var test_variable = 50;
                test_variable += 13.2;
        ...
        [Test]
        public void Test_Variable_Addition_Modification_With_First_Argument_As_Float_And_Second_Argument_As_Integer_Should_Produce_Valid_Float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Subtraction_Modification_With_First_Argument_As_Integer_And_Second_Argument_As_Float_Should_Produce_Valid_float()
        {
            var code = @"
                var test_variable = 50;
                test_variable -= 5.5;
        ...
        [Test]
        public void Test_Variable_Subtraction_Modification_With_First_Argument_As_Float_And_Second_Argument_As_Integer_Should_Produce_Valid_float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Multiplication_Modification_With_First_Argument_As_Integer_And_Second_Argument_As_Float_Should_Produce_Valid_float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Multiplication_Modification_With_First_Argument_As_Float_And_Second_Argument_As_Integer_Should_Produce_Valid_float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Division_Modification_With_First_Argument_As_Integer_And_Second_Argument_As_Float_Should_Produce_Valid_Float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Division_Modification_With_First_Argument_As_Float_And_Second_Argument_As_Integer_Should_Produce_Valid_Float()
        {
            var code = @"
        ...
        [Test]
        public void Test_Variable_Modulus_Modification_With_First_Argument_As_Integer_And_Second_Argument_As_Float_Should_Produce_Valid_Float()
        {
            var code = @"
                var test_variable = 100;
                test_variable %= 7.7;
        ...
        [Test]
        public void Test_Variable_Modulus_Modification_With_First_Argument_As_Float_And_Second_Argument_As_Integer_Should_Produce_Valid_Float()
        {
            var code = @"
